...
class Balancer():
    ...
    '''
    def __init__(self, reactant_matrix:np.array, product_matrix:np.array, rounding_order:int) -> None:
        ...
        self.coefficient_limit:int = 10000
    ...
    def auto_balance_reaction(self) -> list:
        ...
        a Thorne algorithm and Risteski algorithm.
        '''
        # try Thorne
        try:
            coefficients = self.calculate_coefficients_Thorne()
            coefficients = self.round_up_coefficients(coefficients, self.rounding_order)
            coefficients = self.intify_coefficients(coefficients, self.coefficient_limit)
