...
class Balancer():
    ...
    Args:
    * `reactant_matrix`: matrix of reactants property generated by `ChemicalReaction` class,  NumPy array
    * `product_matrix`: matrix of products property generated by `ChemicalReaction` class, NumPy array
    * `rounding_order`: order of coefficients rounding, int
    '''
    def __init__(self, 
